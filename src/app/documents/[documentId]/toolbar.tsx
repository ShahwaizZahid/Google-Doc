    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <Input
          ...
          className="h-7 w-10 text-sm  text-center border border-neutral-400 rounded-sm bg-transparent focus:ring-0 focus:outline-none"
        />
      ) : (
        <button
          onClick={() => {
